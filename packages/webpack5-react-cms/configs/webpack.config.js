 ...
 * @LastEditors   : hadeshe
 * @LastEditTime  : 2022-08-11 19:29:20
 * @FilePath      : /webpack5-starter/packages/webpack5-starter-react-ts/configs/webpack.config.js
 */
    ...
    ...(isDevMode
      ...
      : [
          ...
          new AddAssetHtmlPlugin(
            [...getDllFilePathMap().values()].map((filepath) => ({
              publicPath: '../common/',
              outputPath: '../common/',
              filepath
            }))
